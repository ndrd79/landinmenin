            ...
            <div className="mx-auto max-w-[1280px] relative z-10">
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-start">
                    ...
                    <div className="flex flex-col gap-6">
                        <div className="bg-gradient-to-br from-primary-dark via-primary to-primary-light rounded-3xl p-8 text-white shadow-2xl relative overflow-hidden">
                            ...
                            <a
                                ...
                                className="inline-flex items-center gap-3 bg-white text-primary px-8 py-4 rounded-2xl font-bold hover:shadow-lg transition-all"
                            >
